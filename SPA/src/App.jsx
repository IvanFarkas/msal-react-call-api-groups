...
const Pages = () => {
  return (
    <Switch>
      <RouteGuard exact path="/todolist" groups={[securityGroups.GroupMember, securityGroups.GroupAdmin]} Component={TodoList} />
      <RouteGuard exact path="/dashboard" groups={[securityGroups.GroupAdmin]} Component={Dashboard} />
      <Route path="/overage">
        <Overage />
      </Route>
    </Switch>
...
/**
 * msal-react is built on the React context API and all parts of your app that require authentication must be wrapped in the MsalProvider component.
