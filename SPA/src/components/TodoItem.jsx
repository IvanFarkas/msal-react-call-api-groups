...
export const TodoItem = (props) => {
    ...
    <div className="todo-edit">
      <Form onSubmit={handleSubmit}>
        <Form.Group>
          ...
          <Form.Control id={props.id} type="text" value={newName} onChange={handleChange} ref={editFieldRef} />
        </Form.Group>
  ...
  const viewTemplate = (
    <div className="todo-view">
      <Form.Group>
        <Form.Check inline id={props.id} type="checkbox" defaultChecked={props.completed} onChange={() => props.completeTask(props.id)} />
