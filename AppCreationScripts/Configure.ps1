...
#> 
   ...
   $dictionary = @{ "Tenant_Id" = $tenantId;"Application_Id" = $serviceAadApplication.AppId;"Client_Secret" = $serviceAppKey; "Object_Id_of_GroupAdmin_Group" = $groupAdmin.objectId; "Object_Id_of_GroupMember_Group" = $groupMember.objectId };
   ReplaceInTextFile -configFilePath $configFile -dictionary $dictionary

   # Update config file for 'client'
   $configFile = $pwd.Path + "\..\SPA\src\authConfig.js"
   Write-Host "Updating the sample code ($configFile)"
   $dictionary = @{ "Application_Id" = $clientAadApplication.AppId;"Tenant_Id" = $tenantId;"Web_Api_Scope_here" = ("api://"+$serviceAadApplication.AppId+"/access_as_user"); "Object_Id_of_GroupAdmin_Group" = $groupAdmin.objectId; "Object_Id_of_GroupMember_Group" = $groupMember.objectId };
   ReplaceInTextFile -configFilePath $configFile -dictionary $dictionary
   Write-Host ""
